...
describe("commenter class", function()
	...
	it("can initialize bash commenter", function()
		local c = Commenter:new("bash")
		assert.equals(c.filetype, "bash")
		assert.equals(c.config.line_comment, "# ")
		assert.equals(c.config.block_comment, nil)
	end)
	it("can initialize c commenter", function()
		local c = Commenter:new("c")
		assert.equals(c.filetype, "c")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	it("can initialize cs commenter", function()
		local c = Commenter:new("cs")
		assert.equals(c.filetype, "cs")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	it("can initialize css commenter", function()
		...
		assert.equals(c.config.line_comment, nil)
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	it("can initialize cpp commenter", function()
		local c = Commenter:new("cpp")
		assert.equals(c.filetype, "cpp")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	it("can initialize dart commenter", function()
		local c = Commenter:new("dart")
		assert.equals(c.filetype, "dart")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	...
	it("can initialize elixir commenter", function()
		local c = Commenter:new("elixir")
		assert.equals(c.filetype, "elixir")
		assert.equals(c.config.line_comment, "# ")
		assert.equals(c.config.block_comment, nil)
	end)
	...
	it("can initialize java commenter", function()
		local c = Commenter:new("java")
		assert.equals(c.filetype, "java")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	...
	it("can initialize kdl commenter", function()
		local c = Commenter:new("kdl")
		assert.equals(c.filetype, "kdl")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	it("can initialize kotlin commenter", function()
		local c = Commenter:new("kotlin")
		assert.equals(c.filetype, "kotlin")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	it("can initialize lisp commenter", function()
		local c = Commenter:new("lisp")
		assert.equals(c.filetype, "lisp")
		assert.equals(c.config.line_comment, "; ")
		assert.equals(c.config.block_comment, nil)
	end)
	...
	it("can initialize matlab commenter", function()
		local c = Commenter:new("matlab")
		assert.equals(c.filetype, "matlab")
		assert.equals(c.config.line_comment, "% ")
		assert.are.same(c.config.block_comment, { "%{", "}%" })
	end)
	it("can initialize perl commenter", function()
		local c = Commenter:new("perl")
		assert.equals(c.filetype, "perl")
		assert.equals(c.config.line_comment, "# ")
		assert.equals(c.config.block_comment, nil)
	end)
	it("can initialize php commenter", function()
		local c = Commenter:new("php")
		assert.equals(c.filetype, "php")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	...
	it("can initialize ruby commenter", function()
		local c = Commenter:new("ruby")
		assert.equals(c.filetype, "ruby")
		assert.equals(c.config.line_comment, "# ")
		assert.equals(c.config.block_comment, nil)
	end)
	it("can initialize rust commenter", function()
		local c = Commenter:new("rust")
		assert.equals(c.filetype, "rust")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	it("can initialize scala commenter", function()
		local c = Commenter:new("scala")
		assert.equals(c.filetype, "scala")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	...
	it("can initialize swift commenter", function()
		local c = Commenter:new("swift")
		assert.equals(c.filetype, "swift")
		assert.equals(c.config.line_comment, "// ")
		assert.are.same(c.config.block_comment, { "/* ", " */" })
	end)
	...
	it("can initialize vim commenter", function()
		local c = Commenter:new("vim")
		assert.equals(c.filetype, "vim")
		assert.equals(c.config.line_comment, '" ')
		assert.equals(c.config.block_comment, nil)
	end)
	it("can initialize xml commenter", function()
		local c = Commenter:new("xml")
		assert.equals(c.filetype, "xml")
		assert.equals(c.config.line_comment, nil)
		assert.are.same(c.config.block_comment, {"<!-- ", " -->"})
	end)
	...
	it("can initialize zsh commenter", function()
		local c = Commenter:new("zsh")
		assert.equals(c.filetype, "zsh")
		assert.equals(c.config.line_comment, "# ")
		assert.equals(c.config.block_comment, nil)
	end)
